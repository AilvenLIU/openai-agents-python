...
def test_streaming_stt_trace_records_transcription_options_with_sensitive_data() -> None:
    session = OpenAISTTTranscriptionSession(
        input=StreamedAudioInput(),
        client=AsyncMock(api_key="FAKE_KEY"),
        model="gpt-live-transcribe",
...
def test_streaming_stt_trace_redacts_keywords_without_sensitive_data() -> None:
