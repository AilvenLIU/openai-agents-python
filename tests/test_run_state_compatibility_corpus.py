...
@pytest.mark.parametrize(
    ...
    [
        ...
        (_system_exit_with_effective_code(False, True), SystemExit, (1,)),
        (_system_exit_with_effective_code(True, False), SystemExit, (1,)),
    ...
    ids=[
        ...
        "system-exit-false",
        "system-exit-true",
        "system-exit-stale-false-argument",
        "system-exit-stale-true-argument",
        "system-exit-none",
        "keyboard-interrupt",
